...
maxheaders=1e6;  % maximum number of images we can read (1000 MB of data)
...
%[IH,count]=fread(hdr,[256 maxheaders+1],'double');
...
[n nim]=size(IH);
% Raimond Ravelli 5 march 2013 Get correct number of images
%nim=idat(2);
